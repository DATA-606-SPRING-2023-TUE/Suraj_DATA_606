...
## Outcomes
* To perform EDA to give meaningful analysis of the data.
* Find the correlation between posture and personality.
* To apply various combinations of machine learning models to get the desired outcome.
* Using various evaluation techniques to find the performance of the models.
